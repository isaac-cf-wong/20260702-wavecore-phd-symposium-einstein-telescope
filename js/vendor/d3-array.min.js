...
!(function (t, n) {
            ...
            return (
                u && l
                    ...
                    : u
                      ...
                      : l &&
                        (y(l, o, c, f, i), y(l, c, o, f, i), y(l, o, c, f, i)),
                n
            )
        }
    }
    ...
    function W(t, n, r) {
        ...
        for (;;) {
            ...
            ;(o > 0
                ...
                : o < 0 &&
                  ((t = Math.ceil(t * o) / o), (n = Math.floor(n * o) / o)),
                (e = o))
        }
    }
    function X(t) {
    ...
    function it(t, n, r = f) {
        if (!isNaN((n = +n))) {
            if (
                ((e = Float64Array.from(t, (n, e) => f(r(t[e], e, t)))), n <= 0)
            )
                return nt(e)
            if (n >= 1) return $(e)
            var e,
    ...
    function at(t) {
        ...
        for (var n = -1, r = tt(t, ht), e = new Array(r); ++n < r; )
            for (var o, f = -1, i = (e[n] = new Array(o)); ++f < o; )
                i[f] = t[f][n]
        return e
    }
    function ht(t) {
    ...
    ;((t.Adder = N),
        ...
        (t.mode = function (t, n) {
            ...
            if (void 0 === n)
                for (let n of t)
                    null != n && n >= n && r.set(n, (r.get(n) || 0) + 1)
            else {
                let e = -1
                for (let o of t)
                    null != (o = n(o, ++e, t)) &&
        ...
        (t.thresholdFreedmanDiaconis = function (t, n, r) {
            ...
            return e && o
                ? Math.ceil((r - n) / (2 * o * Math.pow(e, -1 / 3)))
                : 1
        }),
