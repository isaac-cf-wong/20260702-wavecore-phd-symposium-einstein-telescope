...
!(function (n, t) {
        ...
        return [
            ...
            t *
                (1.007226 +
                    r *
                        (0.015085 +
                            e * (0.028874 * r - 0.044475 - 0.005916 * e))),
        ]
    }
    function Ae(n, t) {
        return [h(t) * S(n), S(t)]
    ...
    ;((xe.invert = function (n, t) {
        ...
        (n.geoBounds = function (n) {
            var t, r, e, i, o, u, a
            if (
                ((H = F = -(O = k = 1 / 0)), (D = []), j(n, An), (r = D.length))
            ) {
        ...
        (n.geoCircle = function () {
            ...
            return (
                (u.center = function (n) {
                    return arguments.length
                        ? ((r =
                              'function' == typeof n ? n : Un([+n[0], +n[1]])),
                          u)
                        : r
                }),
                (u.radius = function (n) {
        ...
        (n.geoPath = function (n, t) {
            ...
            function u(n) {
                return (
                    n &&
                        ('function' == typeof o &&
                            e.pointRadius(+o.apply(this, arguments)),
                        j(n, r(e))),
                    e.result()
                )
            }
